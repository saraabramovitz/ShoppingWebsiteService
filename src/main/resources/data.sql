...
INSERT INTO user (first_name, last_name, email, phone, city, street, buildingNumber, apartment, username,  password, roles, permissions) VALUES
    ('Avi', 'David','avi338@gamil.com', '0527842338', 'Jerusalem', 'Hakinar', 25,  6, 'avia', 'Aa123456789!', '', ''),
    ('Kfir', 'Arbel','kfir.arbel@gamil.com', '0545874514', 'Rehovot', 'Hatikva', 118,  2, 'kfira', 'Kk123456789!', '', '');
